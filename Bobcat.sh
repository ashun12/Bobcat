...
EXT_NET_CIDR=$(whiptail --inputbox "Please Enter Provider/External Network CIDR Range 🕸 (EX:- 172.16.24.0/23..) " --title " 🕸 Openstack External CIDR Range 🕸 " 10 95 3>&1 1>&2 2>&3 )
...
git clone https://github.com/ashun12/Logos
cd /etc/kolla/Logos/
